...
class ModelRunner():
    def __init__(self, setting):
        ...
        self.model = AutoModelForCausalLM.from_pretrained( setting.llm_path, device_map=setting.device).to(setting.device)
...
if __name__ == '__main__':
    ...
    setting.model_name = "meta-llama/Llama-3.3-70B-Instruct"  # the default model name on HuggingFace, in case you want to download it.
    ...
    # there is also openai/gpt-oss-20b smaller version of the model
    ...
    parser.add_argument("--device", default="cuda:0", help="device could be cpu or cuda:0 cuda:1 etc", type=str)
